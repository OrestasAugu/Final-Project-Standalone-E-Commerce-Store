	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Description" style="width:250px;" maxLength="2000" required></td>
							</tr>
							<tr>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_euro.php");
			}}
		}
...
<div id="leftnav">
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Euros</h2></center></div>
			<br />
