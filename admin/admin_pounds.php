...
<body>
		...
		<label>Props4You</label>
			...
			<ul>
				...
				<li>Welcome:&nbsp;&nbsp;&nbsp;<a><i class="icon-user icon-white"></i><?php echo $fetch['username']; ?></a></li></b>
			</ul>
	</div>
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Description" style="width:250px;" maxLength="200" required></td>
							</tr>
							<tr>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_pounds.php");
			}}
		}
...
<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Featured Products</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Dollars</a></li>
					<li><a href="admin_euro.php" style="font-size:15px; margin-left:15px;">Euros</a></li>
					<li><a href="admin_pounds.php"style="font-size:15px; margin-left:15px;">Pounds</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Pounds</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Search Products" id="filter"></label>
			<br />
